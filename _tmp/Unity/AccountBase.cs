...
namespace KBEngine
{
	...
	public abstract class AccountBase : Entity
	{
		...
		public abstract void onReqAvatarInfo(string arg1); 
		public abstract void onSetAvatarResult(string arg1); 
		...
		public override void onRemoteMethodCall(MemoryStream stream)
		{
			...
			{
				case 4:
					string onReqAvatarInfo_arg1 = stream.readUnicode();
					onReqAvatarInfo(onReqAvatarInfo_arg1);
					break;
				case 5:
					string onSetAvatarResult_arg1 = stream.readUnicode();
					onSetAvatarResult(onSetAvatarResult_arg1);
					break;
				default:
					break;
			};
